...
# Fix providers section - restructure the conditional rendering
old_providers = '''{providers.length > 0 || loadingProviders) && (
...
new_providers = '''{(providers.length > 0 || loadingProviders) && (
          <section style={{ marginTop: 16 }}>
            <div style={{ 
              display: 'flex', 
              justifyContent: 'space-between', 
