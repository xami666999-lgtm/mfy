...
# The issue is with <> fragments inside ternary. Let's replace them with <div> wrappers
# This is more reliable for TypeScript parsing

# Fix skeleton fragment (lines 894-931)
old_skeleton = '''              {loadingAiring ? (
                <>
...
# Fix content fragment (lines 933-1004)
old_content = ''') : (
                <>
              {/* Airing Anime */}
...
print("Fixed airing section - replaced fragments with divs")