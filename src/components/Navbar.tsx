import { Home, Film, Tv, Trophy, Search, Bookmark, Settings, BookOpen, Sparkles, Radio } from 'lucide-react'
  ...
  return (
    <header className="mfy-navbar select-none">
      <button onClick={() => setCurrentPage('home')} className="brand" aria-label="MFY Board" type="button">
        ...
        <span>MFY</span>
        <span className="text-[10px] text-[#FF1493] font-bold ml-1">1.2.48</span>
      </button>
