...
export const streamingServices: StreamingService[] = [
  ...
  { id: 'apple', name: 'Apple TV+', color: '#A3AAAE', logo: './logos/apple-tv.png', tmdbId: 350 },
  ...
  { id: 'crunchyroll', name: 'Crunchyroll', color: '#F47521', logo: './logos/crunchyroll.png', tmdbId: 283 },
