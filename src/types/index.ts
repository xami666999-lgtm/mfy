...
export type Page = 'home' | 'discover' | 'search' | 'search-results' | 'library' | 'settings' | 'detail' | 'player' | 'wizard' | 'guide' | 'provider' | 'franchise' | 'movies' | 'tv' | 'anime' | 'sports' | 'iptv' | 'providers' | 'franchises' | 'manga' | 'manga-detail' | 'airing' | 'mangayomi' | 'mangayomi-detail' | 'zangetsu' | 'zangetsu-detail' | 'simplstream' | 'simplstream-detail' | 'comics' | 'books' | 'youtube' | 'music'
