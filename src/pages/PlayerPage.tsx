      ...
      <div className="player-stage" onClick={togglePlay}>
        ...
        {!loaded && (
          <div className="player-empty" onClick={(e) => e.stopPropagation()}>
            ...
            <h2>Ready to play</h2>
            <p>Paste an authorized MP4, HLS, or DASH stream URL.</p>
            <div className="stream-input-row">
              <Link2 />
              <input value={streamUrl} onChange={(e) => setStreamUrl(e.target.value)} onKeyDown={(e) => e.key === 'Enter' && loadStream(streamUrl)} placeholder="https://example.com/video.m3u8" />
