...
# Replace the entire airing section with a cleaner version
old_airing = '''        {/* Airing Schedule Section */}
...
new_airing = '''        {/* Airing Schedule Section */}
        {(airingAnime.length > 0 || airingTVShows.length > 0 || loadingAiring) && (
          <section style={{ marginTop: 16 }}>
            <div style={{ 
              display: 'flex', 
...
print("Replaced entire airing section")