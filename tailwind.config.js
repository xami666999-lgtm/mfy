  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'glow-pink': '0 0 20px rgba(255, 20, 147, 0.2), 0 0 40px rgba(255, 20, 147, 0.08)',
        'glow-cyan': '0 0 20px rgba(0, 229, 255, 0.2), 0 0 40px rgba(0, 229, 255, 0.08)',
        'glow-pink-strong': '0 0 30px rgba(255, 20, 147, 0.4), 0 0 60px rgba(255, 20, 147, 0.15)',
        'glow-cyan-strong': '0 0 30px rgba(0, 229, 255, 0.4), 0 0 60px rgba(0, 229, 255, 0.15)',
      },
      animation: {
